# Site Brief — Abonnement IPTV Officiel
...
- **Business name:** Abonnement IPTV Officiel
...
- **This site owns:** Trial/deals: 'test iptv gratuit', 'essai iptv', 'iptv pas cher' + ALL hardware/boitier terms (it ranks for them).
- **This site NEVER touches:** FR head terms (prime). NOTE: /test-iptv and /boitier-iptv are FROZEN (Google re-evaluation) — support via internal links only, zero on-page edits until probes clear them.
...
direct, orienté essai, sans risque

### The reader

- **Who is reading:** French user who wants to try before buying; deal-hunter; also boitier/hardware buyers
