...
- **Primary location(s):** Albania (digital service, no physical location)
- **Country for search data:** Albania
- **Language for search data:** Albanian (sq)

### Portfolio lane (HARD anti-cannibalization contract)

- **This site owns:** Albanian market — sole sq site, owns the whole lane. Ranks via mixed-language SERPs.
- **This site NEVER touches:** Nothing portfolio-internal — sole Albanian site.
...
i drejtpërdrejtë, miqësor

### The reader

- **Who is reading:** Albanian-speaking viewer (often diaspora) wanting home channels abroad
- **Reading level:** simple, non-technical (Albanian); short sentences
...
| plain Albanian, short sentences | machine-translated phrasing |

### Sentence style

- **Person:** second person (Albanian formal "you"); first person plural for the service
- **Contractions:** natural Albanian usage
