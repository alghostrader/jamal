...
- **Primary location(s):** Spain (digital service, no physical location)
- **Country for search data:** Spain
- **Language for search data:** Spanish (es)
...
- **Person:** second person (Spanish formal "you"); first person plural for the service
- **Contractions:** natural Spanish usage
