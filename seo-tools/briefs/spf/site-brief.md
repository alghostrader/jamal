# Site Brief — Smarters Pro France
...
- **Business name:** Smarters Pro France
...
- **This site owns:** 'iptv smarters' install/config long-tail (8,100/mo cluster): device-by-device install guides are the asset.
- **This site NEVER touches:** 'application iptv' head term (smarters-live), 'abonnement iptv' head term (prime).
...
- **Who is reading:** French user installing IPTV Smarters Pro on a specific device (Firestick, Smart TV, box)
