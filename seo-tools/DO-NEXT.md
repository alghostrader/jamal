# DO NEXT — IPTV portfolio · generated 2026-09-09 by the dashboard audit
...
- id: `1b34668fff` · score 58 · Medium ≈40 min · GSC pos 4.1 · 55 clicks · 220 impr / 28d
...
- what: “listas iptv telegram” sits at position 4 with 220 impressions/28d. Strengthen internal links to the ranking page and refresh the content section matching this query.
...
### #2 Striking distance — iptv segura · iptvsegura.com
- id: `ee2bf478f4` · score 58 · Medium ≈40 min · GSC pos 23.4 · 0 clicks · 18 impr / 28d
- repo: `⚠ set repo path (not in the owner's report)` (guias/)
- action: **ENHANCE** → https://iptvsegura.com/
- ⚠ the homepage ranks this term — enhance the homepage section, never a new URL
- what: “iptv segura” sits at position 23 with 18 impressions/28d. Strengthen internal links to the ranking page and refresh the content section matching this query.
- deploy-as: alghostrader · git push origin main → Vercel auto · guards: title ≤ 60 chars (build fails otherwise) · no rights-holder / channel / league / broadcaster names · real hero image (no icon fallback) · brand or naked-URL anchors only for links
- done when: 3+ internal links point at the ranking page with varied anchors / on-query section refreshed + dateModified bumped / deploy READY + live fetch finds the keyword on the page

### #3 Backlink — Substack post · rodaktv.com
...
### #4 Backlink — Hotfrog listing · rodaktv.com
...
### #7 Striking distance — meilleur boîtier iptv 2026 · abonnementiptvofficiel.com
- id: `9f828be461` · score 51 · Medium ≈40 min · GSC pos 7.1 · 20 clicks · 224 impr / 28d
- repo: `/Desktop/abonnementiptvofficiel` (MDX content/blog)
- action: **ENHANCE** → https://abonnementiptvofficiel.com/boitier-iptv
- ⚠ page already ranks this term — enhance it, never a new URL
- what: “meilleur boîtier iptv 2026” sits at position 7 with 224 impressions/28d. Strengthen internal links to the ranking page and refresh the content section matching this query. (backfilled from Monitor: the queue was short)
- deploy-as: alghostrader · git push origin main → Vercel auto · guards: title ≤ 60 chars (build fails otherwise) · no rights-holder / channel / league / broadcaster names · real hero image (no icon fallback) · brand or naked-URL anchors only for links
- done when: 3+ internal links point at the ranking page with varied anchors / on-query section refreshed + dateModified bumped / deploy READY + live fetch finds the keyword on the page
...
- id: `737de905a9` · score 0 · — ≈0 min · GSC pos 13.7 · 11 clicks · 264 impr / 28d
- repo: `/Desktop/abonnementiptvofficiel` (MDX content/blog)
- action: **ENHANCE** → https://abonnementiptvofficiel.com/boitier-iptv
- ⚠ page already ranks this term — enhance it, never a new URL
...
- deploy-as: alghostrader · git push origin main → Vercel auto · guards: title ≤ 60 chars (build fails otherwise) · no rights-holder / channel / league / broadcaster names · real hero image (no icon fallback) · brand or naked-URL anchors only for links
- done when: 3+ internal links point at the ranking page with varied anchors / on-query section refreshed + dateModified bumped / deploy READY + live fetch finds the keyword on the page
- live check (2026-09-09): page is live but declares no modified date — add dateModified / og:updated_time so the change can be verified

### … Striking distance — boitier iptv · abonnementiptvofficiel.com
- id: `8fcbe4f4aa` · score 0 · — ≈0 min · GSC pos 21.6 · 5 clicks · 170 impr / 28d
- repo: `/Desktop/abonnementiptvofficiel` (MDX content/blog)
- action: **ENHANCE** → https://abonnementiptvofficiel.com/boitier-iptv
- ⚠ page already ranks this term — enhance it, never a new URL
...
- live check (2026-09-09): 5 page(s) still under 300 words live: /checkout?plan=3mois-1ecran, /checkout?plan=6mois-1ecran, /checkout?plan=12mois-1ecran, /checkout?plan=24mois-1ecran
...
- deploy-as: alghostrader · git push origin main → Vercel auto · guards: title ≤ 60 chars (build fails otherwise) · no rights-holder / channel / league / broadcaster names · real hero image (no icon fallback) · brand or naked-URL anchors only for links
- done when: defect fixed in the repo (all flagged pages) / deploy READY / live re-check passes (thin pages ≥ 300 words / redirect 308 / zero broken links)
- live check (2026-09-09): 5 page(s) still under 300 words live: /checkout?plan=1ekran-3m, /checkout?plan=1ekran-6m, /checkout?plan=1ekran-12m, /checkout?plan=1ekran-24m
...
- live check (2026-09-09): page is live but its modified date is before 2026-09-06

### … Striking distance — iptv shqiptar · iptvshqiptar.com
- id: `98a4408a71` · score 0 · — ≈0 min · GSC pos 9.9 · 1 clicks · 27 impr / 28d
- repo: `/Desktop/iptvshqip` (lib/posts.ts)
...
- deploy-as: alghostrader · git push origin main → Vercel auto · guards: title ≤ 60 chars (build fails otherwise) · no rights-holder / channel / league / broadcaster names · real hero image (no icon fallback) · brand or naked-URL anchors only for links
- done when: 3+ internal links point at the ranking page with varied anchors / on-query section refreshed + dateModified bumped / deploy READY + live fetch finds the keyword on the page
- live check (2026-09-09): page is live but its modified date is before 2026-09-08
...
- deploy-as: alghostrader · git push origin main → Vercel auto · guards: title ≤ 60 chars (build fails otherwise) · no rights-holder / channel / league / broadcaster names · real hero image (no icon fallback) · brand or naked-URL anchors only for links
- done when: defect fixed in the repo (all flagged pages) / deploy READY / live re-check passes (thin pages ≥ 300 words / redirect 308 / zero broken links)
- live check (2026-09-09): 5 page(s) still under 300 words live: /checkout?plan=1pant-3m, /checkout?plan=1pant-6m, /checkout?plan=1pant-12m, /checkout?plan=1pant-24m
...
- deploy-as: alghostrader · git push origin main → Vercel auto · guards: title ≤ 60 chars (build fails otherwise) · no rights-holder / channel / league / broadcaster names · real hero image (no icon fallback) · brand or naked-URL anchors only for links
- done when: defect fixed in the repo (all flagged pages) / deploy READY / live re-check passes (thin pages ≥ 300 words / redirect 308 / zero broken links)
- live check (2026-09-09): 5 page(s) still under 300 words live: /afrekenen?plan=3-maanden-1-scherm, /afrekenen?plan=6-maanden-1-scherm, /afrekenen?plan=12-maanden-1-scherm, /afrekenen?plan=24-maanden-1-scherm
...
## Monitor — 95 watch items (do not work on these)
